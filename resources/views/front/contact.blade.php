...
<style>
    .multibackground {
        background-image: url(public/assets/front/img/left.png), url(public/assets/front/img/left.png);
...
@section('content')
    ...
    <section class="contacts-section" style="background-image: url('{{ asset('assets/front/img/img1.png') }}');">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form_group mb-5">
                                        <input type="text" class="form_control" placeholder="{{ __('Full Name') }}"
                                            name="name" required>
                                        @if ($errors->has('name'))
                                ...
                                <div class="col-lg-6">
                                    <div class="form_group mb-5">
                                        <input type="email" class="form_control" placeholder="{{ __('Email Address') }}"
                                            name="email" required>
                                        @if ($errors->has('email'))
                                ...
                                <div class="col-lg-12">
                                    <div class="form_group mb-5">
                                        <input type="text" class="form_control" placeholder="{{ __('Subject') }}"
        ...
        <div class="row mt-25 mb-25"
            style="left: 10pt; background-color: rgba(255, 255, 255, 0.3);
