...
class FrontendController extends Controller
{
    ...
    public function userDetailView($domain)
    {
        ...
        elseif ($ubs->theme == 11) {
            return view('user.profile1.theme11.main-content.template4', $data);
        }
        elseif ($ubs->theme == 12) {
    ...
    public function userAbout($domain)
    {
        ...
        $ubs = User\BasicSetting::select('theme')->where('user_id', $user->id)->firstOrFail();
        if ($ubs->theme != 3 && $ubs->theme != 16 && $ubs->theme != 14) {
    ...
    public function userServices($domain)
    {
        ...
        elseif ($ubs->theme == 16) {
            return view('user.profile1.theme16.services', $data);
        } elseif ($ubs->theme == 14) {
    ...
    public function userBlogs(Request $request, $domain)
    {
        ...
        if ($ubs->theme == 1) {
            ...
            $data['layout'] = 'theme' . $ubs->theme;
            return view('user.profile1.theme16.blogs', $data);
        }
        elseif ($ubs->theme == 14) {
            $data['layout'] = 'theme' . $ubs->theme;
    ...
    public function userPortfolioDetail($domain, $slug, $id)
    {
        ...
        $ubs = User\BasicSetting::select('theme')->where('user_id', $userId)->firstOrFail();
        if ($ubs->theme == 1 || $ubs->theme == 2 || $ubs->theme == 9) {
            $data['folder'] = "profile1";
        } elseif ($ubs->theme == 3) {
            $data['folder'] = "profile1.theme3";
        } elseif ($ubs->theme == 4) {
    ...
    public function userContact($domain)
    {
        ...
        elseif ($ubs->theme == 16 ) {
            $data['layout'] = 'theme' . $ubs->theme;
            return view('user.profile1.theme16.contact', $data);
        }
        elseif ($ubs->theme == 14 ) {
            $data['layout'] = 'theme' . $ubs->theme;
